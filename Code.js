...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .badge { width: 68px; height: 68px; background: #131360; border: 2px solid #ebc246; border-radius: 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 20px rgba(235, 194, 70, 0.25); }
    .badge svg { width: 38px; height: 38px; }
    .title-group { display: flex; flex-direction: column; gap: 6px; }
    .inst-name { font-size: 11px; font-weight: 800; letter-spacing: 2px; color: #ebc246; text-transform: uppercase; }
    .campaign-title { font-family: 'Sora', sans-serif; font-size: 20px; font-weight: 700; color: #ffffff; line-height: 1.3; }
    .dest-hint { font-size: 12px; color: #9d9bb8; background: #131329; padding: 8px 14px; border-radius: 12px; border: 1px solid #282846; word-break: break-all; max-width: 100%; }
    ...
    .footer-note { font-size: 11px; color: #6b6985; margin-top: 8px; }
  </style>
  <script>
