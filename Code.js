...
<head>
  ...
  <base target="_top">
  <title>INFOTEP | Redirección Segura</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { background-color: #111125; color: #e2e0fc; font-family: 'Plus Jakarta Sans', sans-serif; min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px; }
    .card { background: #1a1a36; border: 1px solid #323258; border-radius: 28px; padding: 36px 28px; max-width: 420px; width: 100%; text-align: center; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.6); display: flex; flex-direction: column; align-items: center; gap: 20px; animation: fadeIn 0.4s ease-out; }
    @keyframes fadeIn { from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); } }
    .logo-container { width: 80px; height: 80px; background: #ffffff; border-radius: 24px; display: flex; align-items: center; justify-content: center; padding: 12px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.35); border: 2px solid #ebc246; }
    .logo-container svg { width: 100%; height: 100%; }
    .title-group { display: flex; flex-direction: column; gap: 4px; }
    .inst-name { font-size: 12px; font-weight: 800; letter-spacing: 2px; color: #ebc246; text-transform: uppercase; }
    .campaign-title { font-family: 'Sora', sans-serif; font-size: 20px; font-weight: 700; color: #ffffff; line-height: 1.3; }
    .dest-hint { font-size: 12px; color: #9d9bb8; background: #131329; padding: 10px 16px; border-radius: 14px; border: 1px solid #282846; word-break: break-all; max-width: 100%; }
    .dest-hint strong { color: #c0c1ff; }
    .btn-continue { background: #ebc246; color: #131360; font-family: 'Sora', sans-serif; font-size: 14px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; text-decoration: none; padding: 16px 28px; border-radius: 18px; width: 100%; display: inline-flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 10px 25px rgba(235, 194, 70, 0.35); transition: all 0.2s ease; cursor: pointer; }
    .btn-continue:hover { background: #f7d264; transform: translateY(-2px); box-shadow: 0 12px 30px rgba(235, 194, 70, 0.45); }
    .btn-continue:active { transform: scale(0.98); }
    .footer-note { font-size: 11px; color: #6b6985; margin-top: 4px; }
  </style>
</head>
<body>
  <div class="card">
    ...
    <div class="title-group">
      ...
      <h1 class="campaign-title">Enlace Seguro</h1>
    </div>
    <div class="dest-hint">
